...
C --- FAIL EXIT
  ...
  77  CONTINUE
      ...
      IF (IPRINT.GT.0) WRITE(IPRINT,*) 'REJECT=', REJECT
      if (REJECT)THEN
         IF (IPRINT.GT.0) WRITE(IPRINT,*) 'FACC1, SAFE=', FACC1, SAFE
      else
         IF (IPRINT.GT.0) WRITE(IPRINT,*) 'POSNEG, H=', H
      end if 
      IDID=-3
      RETURN
  78  CONTINUE
  ...
  79  CONTINUE
      IF (IPRINT.GT.0) WRITE(IPRINT,979)X
 979  FORMAT(' EXIT OF DOPRI5 AT X=',E20.6) 
      IDID=2
      RETURN
      END
C
